            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden relative">
                ...
                <div className="p-8 flex flex-col items-center text-center mt-2">
                    <div className={`w-16 h-16 rounded-full flex items-center justify-center mb-6 transition-colors duration-300 ${
                        status === "success" ? "bg-green-100 text-green-600" : "bg-purple-100 text-purple-600"
                    }`}>
                    ...
                    <p className="text-gray-500 font-medium text-sm mb-8">
                        {status === "success" 
                            ...
                            : "Enable desktop alerts to get instantly notified when your exam results are published or library books are due."}
                    </p>
