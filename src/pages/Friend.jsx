    ...
    <div className="flex-shrink-0 w-[28rem] flex items-center gap-4 p-4 bg-white rounded-xl shadow-md transition-shadow hover:shadow-lg">
      ...
      <div className="flex-grow overflow-hidden">
        <Link to={`/profile/${user._id}`} className="block">
          <h4 className="text-base font-bold text-gray-800 hover:text-indigo-600 truncate">
            {user.name || user.full_name}
          </h4>
        </Link>
        <p className="text-sm text-gray-500 truncate">Student at your institute</p>
      </div>
...
const SuggestionCard = ({ user, onAdd, onRemove, onCancel }) => {
  return (
    <div className="flex-shrink-0 w-48 bg-white rounded-lg shadow-md overflow-hidden transition-shadow hover:shadow-lg">
      ...
      <div className="p-3">
        <Link to={`/profile/${user._id}`}>
          <h5 className="font-bold text-gray-800 truncate hover:text-indigo-600">
            {user.name || user.full_name}
          </h5>
        </Link>
        ...
        {user.requestSent ? (
          ...
          <>
            <p className="text-sm text-gray-500 mb-2">Student at your institute</p>
            <div className="mt-2 space-y-2">
              <button
...
// 4. Horizontal Scroller Component
